...
static char selbordercolor[]        = "#828a9a"; // #0066AA
static char selbgcolor[]            = "#373c4b"; // #005577
...
static Key keys[] = {
	...
	STACKKEYS(
	     MODKEY|ShiftMask,                          focus)
	STACKKEYS(
	     MODKEY|ControlMask|ShiftMask,              push)
	...
	{ MODKEY|ShiftMask,	XK_r,		spawn,		SHCMD(TERMINAL " -e btm --basic --mem_as_value") },
	...
	{ ControlMask|ShiftMask,
                        XK_v,		spawn,		SHCMD("clipmenu && xdotool type $(xsel --clipboard)") },
	...
	{ MODKEY,			XK_F4,		spawn,		SHCMD(TERMINAL " -e pavucontrol; kill -44 $(pidof dwmblocks)") },
	...
	{ 0, XF86XK_MonBrightnessUp,	spawn,		SHCMD("intel-backlight inc") },
	{ 0, XF86XK_MonBrightnessDown,	spawn,		SHCMD("intel-backlight dec") },
